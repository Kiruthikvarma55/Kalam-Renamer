...
/help for more details about me.."""
    ...
    UPGRADE_TEXT = "/help for more Details"
    DOWNLOAD_START = "Trying to Download in my Server"
    UPLOAD_START = "Uploading... Started"
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry. But, I cannot upload files greater than 1.5GB due to Telegram API limitations."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using Me🤓.**"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Successfully Downloaded in {} seconds.\nUploaded in {} seconds."
    ...
    HELP_USER = """Hai I am Telegram Renamer bot..
